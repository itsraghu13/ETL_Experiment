...
CREATE TABLE IF NOT EXISTS dev_edf_silver.dps_stage.ETL_AUDT_REF (
    ...
    databricks_job_name STRING COMMENT 'Databricks job name to trigger for processing',
    notebook_path STRING COMMENT 'Databricks notebook path for processing',
...
-- Insert sample data with Databricks job names
INSERT INTO dev_edf_silver.dps_stage.ETL_AUDT_REF
(job_name, src_table1, target_table, chg_final, databricks_job_name, notebook_path, desc_text)
VALUES
(
    'JOB_SALES_ETL',
    ...
    'FINAL',
    'Sales_ETL_Processing_Job',
    '/Workspace/ETL_Jobs/Sales_Processing',
    'Daily sales ETL job - append mode'
),
(
    'JOB_CUSTOMER_CDC',
    ...
    'Customer CDC processing - overwrite mode'
),
(
    'JOB_INVENTORY_ETL',
    'dev_edf_bronze.staging.inventory_data',
    'dev_edf_silver.dps_stage.inventory_fact',
    'FINAL',
    'Inventory_ETL_Job',
    '/Workspace/ETL_Jobs/Inventory_Processing',
    'Inventory ETL job - append mode'
);
